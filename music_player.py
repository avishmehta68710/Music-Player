...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    playbtn = Button(buttonframe,text="PLAY",command=self.playsong,width=4,height=2,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=0,padx=10,pady=5)
    # Inserting Pause Button
    playbtn = Button(buttonframe,text="PAUSE",command=self.pausesong,width=5,height=2,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=1,padx=10,pady=5)
    # Inserting Unpause Button
    playbtn = Button(buttonframe,text="UNPAUSE",command=self.unpausesong,width=7,height=2,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=2,padx=10,pady=5)
    # Inserting Stop Button
    playbtn = Button(buttonframe,text="STOP",command=self.stopsong,width=4,height=2,font=("times new roman",16,"bold"),fg="navyblue",bg="gold").grid(row=0,column=3,padx=10,pady=5)
    # Inserting the exit button
    exitbtn = Button(buttonframe,text="EXIT",command=root.destroy,width=3,height=2,font=('times new roman',16,'bold'),fg='navyblue',bg='gold').grid(row=0,column=4,padx=10,pady=5)
    # Audio Testing
    audiotest = Button(buttonframe,text="TEST\n AUDIO",command = self.test,width=5,height=2,font=('times new roman',16,'bold'),fg='navyblue',bg='gold').grid(row=0,column=5,padx=10,pady=5)
    # Recording
    record = Button(buttonframe,text="RECORD",width=8,height=2,font=('times new roman',16,'bold'),fg='navyblue',bg='gold',command=self.record).grid(row=0,column=6,padx=10,pady=5)
    # Rewind
